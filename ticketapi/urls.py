...
from .views import RegisterView, LoginView, LogoutView, ProjectListCreateView, ProjectDetailView, TaskListCreateView, TaskDetailView, AssignTaskView, DocumentView, DocumentDetailView, CommentListCreateView, CommentDetailView, NotificationView, MarkNotificationReadView
